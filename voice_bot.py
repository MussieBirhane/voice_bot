...
class LanguageModelProcessor:
    ...
    def retrieval (self, query: str, index) -> dict:
        try:
    ...
    def process(self, text):
        ...
        """Handle FAQ using the provided document."""
        retrieved_data = self.retrieval(text, index_mussie)
        # print(retrieved_data)
        score = retrieved_data["matches"][0]["score"]
        if score > 0.5:
            return retrieved_data["matches"][0]["metadata"]["answer"]
        else:
